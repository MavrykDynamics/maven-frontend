                    ...
                    <LitepaperIndex>
                        ...
                        <li>
                            ...
                            <ul className="nav">
                                ...
                                <li>
                                    <LitepaperLink
                                        selected={tops['stability-fee'] <= 110 && tops['dynamic-savings-rate-dsr'] > 110}>
                                        <HashLink
                                            to="#stability-fee"
                                            scroll={(el) =>
                                                window.scrollTo({
                        ...
                        <li>
                            ...
                            <ul className="nav">
                                <li>
                                    <LitepaperLink
                                        selected={tops['liquidations'] <= 110 && tops['collateral-auctions'] > 110}>
                                        <HashLink
                                            to="#liquidations"
                                            scroll={(el) =>
                                                window.scrollTo({
                        ...
                        <li>
                            ...
                            <ul className="nav">
                                ...
                                <li>
                                    <LitepaperLink
                                        selected={tops['governance'] <= 110 && tops['satellite-delegations'] > 110}>
                                        <HashLink
                                            to="#governance"
                                            scroll={(el) =>
                                                window.scrollTo({
                        ...
                        <li>
                            <LitepaperLink
                                selected={tops['governance--treasury'] <= 110 && tops['decentralization'] > 110}>
                                <HashLink
                            ...
                            <ul className="nav">
                                <li>
                                    <LitepaperLink
                                        selected={tops['decentralization'] <= 110 && tops['voting-power'] > 110}>
                                        <HashLink
                                            to="#decentralization"
                                            scroll={(el) =>
                                                window.scrollTo({
