...
In order to ensure the credibility & accuracy of the price data provided, Mavryk relies on an array of price feed providers known as ‘Satellites.’ Mavryk Satellites follow a consensus mechanism similar to the LPoS mechanism of Mavryk, and are required to post a security deposit (bond). If there was a malicious attempt to defraud the system, this would result in a slashing of the Satellite’s collateral as a penalty.`,
  },
  governance: {
    ...
    MVK stakeholders simply need to stake & delegate their tokens to a Satellite of their choice, or choose to operate a Satellite themselves. Similar to Mavryk, MVK stakeholders may change Satellites at any moment with zero penalty. This form of delegated democracy helps mitigate low voter turnouts which are detrimental to decentralized entities.
