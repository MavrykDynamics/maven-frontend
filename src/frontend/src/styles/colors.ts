...
export const darkMode: MavrykTheme = {
  ...
  bakeryLightMobBg: 'images/bakery/bakery-light-mob-bg.svg',
  bakeryDarkMobBg: 'images/bakery/bakery-dark-mob-bg.svg',
  bakeryLightDesktopBg: 'images/bakery/bakery-light-desktop-bg.svg',
  bakeryDarkDesktopBg: 'images/bakery/bakery-dark-desktop-bg.svg',
...
export const spaceMode: MavrykTheme = {
  ...
  teamDecor4: '/images/team/team-decor-4-dark.svg',
  subscribeBachground: '/images/subscribe-bg-dark.svg',
  primaryLightMobBg: 'images/lb/lb-light-mob-bg.svg',
  primaryDarkMobBg: 'images/lb/lb-dark-mob-bg.svg',
  primaryLightDesktopBg: 'images/background/lb-light-desktop-bg.svg',
  primaryDarkDesktopBg: 'images/background/lb-dark-desktop-bg.svg',
  mavrykFinanceBg: 'images/mavryk-finance.svg',
  starsBachground: '/images/stars-bg-dark.svg',
  satellitesGradient: 'linear-gradient(180deg, #160E3F 3.55%, #321F71 103.84%);',
  skyGradientTransparent:
